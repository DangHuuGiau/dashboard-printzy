  ...
  const statusColor = (status: string): string => {
    switch (status) {
      case OrderStatus.PROCESSING:
        return 'bg-blue-500/20 text-blue-700'; // Màu xanh dương
      case OrderStatus.DELIVERY:
        return 'bg-orange-500/20 text-orange-700'; // Màu cam
      case OrderStatus.COMPLETED:
        return 'bg-green-500/20 text-green-700'; // Màu xanh lá
      case OrderStatus.CANCELLED:
        return 'bg-red-500/20 text-red-700'; // Màu đỏ
      case OrderStatus.REFUNDED:
        return 'bg-yellow-500/20 text-yellow-700'; // Màu vàng
      default:
